    ...
    <div className='bg-[#fff6ea] mx-auto'>
        ...
        <div className="mx-auto flex lg:py-10 md:py-10 py-10 md:mx-auto flex-col items-center" >
          <div className="lg:flex-grow md:w-1/2 flex flex-col md:items-center md:text-center lg:mb-10 md:mb-10 items-center text-center" id='main1'>
            ...
            <p className="lg:w-[70%] md:w-[100%] w-[90%] text-black text-center lg:text-lg md:text-lg text-base lg:mx-44 md:mx-14 mx-0 font-normal lg:leading-9" id='about1' data-aos="zoom-in-up"
              data-aos-delay="300"
            >
              At Curious Cubs, we believe that every child deserves the opportunity to grow up happy, healthy, and confident. We understand that being a parent can be a challenging and overwhelming experience, and we want to make it easier for parents to provide their children with the best possible start in life.</p>
        ...
        <div className="carousel mx-auto lg:h-96 md:h-[75%] h-60 bg-[#1E0E13]">
          ...
          <div id="item3" className="flex carousel-item w-[100%]">
            ...
            <div className='lg:w-1/2 md:w-1/2 text-black lg:px-28 md:px-10 lg:my-auto md:my-auto my-auto'>
              ...
              <p className='lg:w-fit md:w-fit w-[95%] md:h-[20vh] lg:h-[45vh] h-[15vh] lg:text-left md:text-left text-justify text-white lg:text-base md:text-sm text-base lg:leading-8 md:leading-6 leading-4' id='about2' >But we're more than just a toy delivery service. We're a community of like-minded parents who share a common goal: to give our children the best possible start in life. With Curious Cubs, you'll have access to a supportive network of parents who are going through the same challenges and joys of parenting as you are.</p>
      ...
      <div className=" lg:mx-auto md:mx-auto flex lg:py-10 md:py-10 py-10 flex-col items-center" id='bgcolor'>
        <div className="lg:flex-grow md:w-1/2 lg:my-20 md:my-20 flex flex-col md:items-start md:text-left md:mb-0 items-center text-center" id='main1'>
          ...
          <p className="w-fit text-black text-justify lg:text-lg lg:mx-60 md:mx-20 mx-5 font-normal leading-8" id='about1'>These values guide everything we do at Curious Cubs, and we're committed to upholding them in all aspects of our business."</p>
          <div className='w-[100%]'>
          </div>
        </div>
      </div>
