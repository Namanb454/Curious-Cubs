...
function Contact() {
    ...
    const submitData = async (event) => {
        ...
        const res = await fetch(
            "https://curious-cubs-default-rtdb.firebaseio.com/userDataRecords.json",
            {
                method: "POST",
                headers: {
            ...
            <div className=" bg-[#fff6ea] lg:mx-auto flex lg:py-10 md:py-10 md:mx-auto flex-col items-center" >
                <div className="lg:flex-grow md:w-1/2 flex flex-col md:items-center md:text-center lg:mb-10 md:mb-10 items-center text-center" id='main1'>
                    ...
                    <div className='flex mx-auto'>
                        <h1 className="title-font lg:text-8xl md:text-7xl lg:mx-auto text-5xl lg:mb-10 md:mb-10 mb-10 font-medium text-gray-900" data-aos="zoom-in" data-aos-delay="400" id='about2heading'>Get In Touch
                        </h1>
                    </div>
                        ...
                        <div className=" mx-auto flex sm:flex-nowrap flex-wrap">
                            ...
                            <div className="bg-[#201528] relative flex flex-wrap rounded shadow-md py-10">
                                <div className=" lg:w-full px-6">
                                    ...
                                    <Link to="https://goo.gl/maps/dCTnNUtyWShVzBic7" className="flex w-3/4 mx-auto my-10 mt-1">
                                        <div className='w-6'>
                                    ...
                                    <Link to="mailto: hello@curiouscubs.com" className="flex w-3/4 mx-auto my-5 mt-1">
                                        <div className='w-6'>
                                            <FiMail className='w-full h-full' />
                                        </div>
                                        <p className='mx-auto'>hello@curiouscubs.com</p>
                                    </Link>
                                </div>
