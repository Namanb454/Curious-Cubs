        ...
        <div className='w-[100%] mx-auto'>
            <footer className="text-gray-600 body-font" id='footer'>
                <div className="px-5 md:px-0 lg:pt-24 md:py-10 pt-10 lg:pb-10 mx-auto flex lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    ...
                    <div className="w-fit flex-grow flex flex-wrap lg:mx-96 lg:mr-auto mx-auto md:pl- mb-10 lg:mt-auto mt-10 md:text-
                    font-semibold text-center">

                        <div className="lg:w-1/3 md:w-1/3 w-[100%] px-4">
                            <Link to='/about' className="title-font text-gray-900 tracking-widest text-sm mb-3" id='footerNav'>About Us</Link>

                        </div>
                        <div className="lg:w-1/3 md:w-1/3 w-[100%] px-4">
                            <Link to='/contact' className="title-font text-gray-900 tracking-widest text-sm mb-3" id='footerNav'>Contact Us</Link>

                        </div>
                        <div className="lg:w-1/3 md:w-1/3 w-[100%] px-4">
                            <Link to='/blogs' className="title-font text-gray-900 tracking-widest text-sm mb-3" id='footerNav'>Resources</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-[100%] lg:mt-10 mt-10 lg:pb-5 pb-5'>
                    ...
                    <div className='lg:flex'>
                        ...
                        <span className="flex lg:ml-auto lg:mt- mt- lg:mx-20  w-[100%] justify-center md:w-auto">
                            ...
                            <Link to='/' className="my-auto mx-2 p-2 rounded-full bg-black"
                            >
                            ...
                            <Link to='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" >
                ...
                <p className="text-gray-500 pb-7 lg:pt-0 pt-2 text-sm text-center">© 2023
                    <Link to="/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@Curious-Cubs</Link>
                </p>
